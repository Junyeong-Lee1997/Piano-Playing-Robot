...
int main(void)
{
    ...
    joinAddr.imr_multiaddr.s_addr = inet_addr("127.0.0.1");
    ...
    */
    ...
    while (1)
    {
        ...
        */
        ...
        Acc_Ptr.move_actu(bf, 400000, 400000);        // linear 제어
        //cout << "패킷수신됨! 패킷을 보낸 클라이언트는 " << inet_ntoa(FromClient.sin_addr) << endl;
        cout << "UDP data:" << bf << endl;
